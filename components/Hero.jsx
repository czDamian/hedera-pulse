...
const Hero = () => {
  return (
    <section
      id="hero"
      className="py-24 md:py-12 lg:py-16 px-8 sm:px-16 lg:px-20"
    >
      {/* bg wavy image  */}
      <Image
        ...
        height={1000}
        width={1000}
        className="w-full md:max-w-2/3 absolute top-10 left-0"
      />
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="text-white">
            <div className="text-center md:text-left text-3xl sm:text-4xl lg:text-4xl font-bold  flex flex-col gap-3 md:gap-4 lg:gap-6 font-[family-name:var(--font-lemon-milk)]">
              <span>LAUNCH</span>
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-[#1A6F0F] via-[#30F917] to-[#71FF60]">
                AI-POWERED TOKENS
              </span>
      ...
      <div className="flex gap-8 text-black font-[family-name:var(--font-kg-red-hands)] text-xs sm:text-sm justify-center md:justify-start">
        <Link
